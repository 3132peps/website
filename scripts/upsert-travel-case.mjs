#!/usr/bin/env node
// ---------------------------------------------------------------------------
// Surgically upsert the Peptide Vial Travel Case (June 2026)
...
//
// Usage:
//   node scripts/upsert-travel-case.mjs            # dry run (reads only, no writes)
//   node scripts/upsert-travel-case.mjs --commit   # actually write to the DB
// ---------------------------------------------------------------------------
...
const NEW_SLUGS = ["peptide-vial-travel-case"];
