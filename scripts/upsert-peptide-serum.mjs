#!/usr/bin/env node
// ---------------------------------------------------------------------------
// Surgically upsert the Elv8 Peptide Serum (June 2026)
...
//
// Usage:
//   node scripts/upsert-peptide-serum.mjs            # dry run (reads only, no writes)
//   node scripts/upsert-peptide-serum.mjs --commit   # actually write to the DB
// ---------------------------------------------------------------------------
...
const NEW_SLUGS = ["elv8-peptide-serum"];
